            ...
            public void onClick(View v) {
                if (continueAndNextBtn.getText().equals("submit") || checker.equals("Code Sent")){
                    ...
                    if (!phoneNumber.equals("")){
                        ...
                        Toast.makeText(RegistrationActivity.this,"Please write valide phone number.",Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            loadingBar.dismiss();
                            Toast.makeText(RegistrationActivity.this, "Congratulations, you are logged in succesfully.", Toast.LENGTH_SHORT).show();
